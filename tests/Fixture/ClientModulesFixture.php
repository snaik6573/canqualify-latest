...
/**
 * ClientModulesFixture
 *
 */
class ClientModulesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'module_id' => ['type' => 'integer', 'length' => 10, 'default' => null, 'null' => true, 'comment' => null, 'precision' => null, 'unsigned' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'client_modules_fk' => ['type' => 'foreign', 'columns' => ['client_id'], 'references' => ['clients', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'client_modules_fk1' => ['type' => 'foreign', 'columns' => ['module_id'], 'references' => ['modules', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
