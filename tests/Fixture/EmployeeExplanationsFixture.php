...
/**
 * EmployeeExplanationsFixture
 *
 */
class EmployeeExplanationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fki_foreign_key1' => ['type' => 'index', 'columns' => ['employee_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'foreign_key1' => ['type' => 'foreign', 'columns' => ['employee_id'], 'references' => ['employees', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
