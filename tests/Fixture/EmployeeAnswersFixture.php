...
/**
 * EmployeeAnswersFixture
 *
 */
class EmployeeAnswersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fki_employee_fkey' => ['type' => 'index', 'columns' => ['employee_id'], 'length' => []],
            'fki_employee_questions_fkey' => ['type' => 'index', 'columns' => ['employee_question_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'employee_fkey' => ['type' => 'foreign', 'columns' => ['employee_id'], 'references' => ['employees', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
