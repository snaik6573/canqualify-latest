...
class RolesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'role_title' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'role_title' => 'Lorem ipsum dolor sit amet',
                'active' => 1,
                'created' => '2019-01-19 08:32:22',
                'modified' => '2019-01-19 08:32:22',
                'created_by' => 1,
                'updated_by' => 1
            ],
        ];
