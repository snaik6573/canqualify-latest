...
/**
 * CustomerRepresentativeFixture
 *
 */
class CustomerRepresentativeFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'customer_representative';
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fki_user_id' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_users_2' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
