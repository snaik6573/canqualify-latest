...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'username' => ['type' => 'string', 'length' => 150, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'fk_users_1_idx' => ['type' => 'index', 'columns' => ['role_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_users_1' => ['type' => 'foreign', 'columns' => ['role_id'], 'references' => ['roles', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'role_id' => 1,
                'active' => 1,
                'created' => '2019-01-24 10:37:58',
                'modified' => '2019-01-24 10:37:58',
                'created_by' => 1,
                'updated_by' => 1,
                'deleted' => '2019-01-24 10:37:58'
            ],
        ];
        parent::init();
    }
