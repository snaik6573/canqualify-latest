 ...
 * NotesStatusFixture
 */
class NotesStatusFixture extends TestFixture
{
    /**
     * Table name
     *
    ...
    public $fields = [
        ...
        'old_status' => ['type' => 'string', 'length' => null, 'default' => null, 'null' => true, 'collate' => null, 'comment' => null, 'precision' => null, 'fixed' => null],
        'new_status' => ['type' => 'string', 'length' => null, 'default' => null, 'null' => true, 'collate' => null, 'comment' => null, 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'fki_notes_status_fk' => ['type' => 'index', 'columns' => ['lead_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'notes_status_fk' => ['type' => 'foreign', 'columns' => ['lead_id'], 'references' => ['leads', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
