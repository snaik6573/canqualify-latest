...
/**
 * SkillAssessmentsFixture
 */
class SkillAssessmentsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 155, 'default' => null, 'null' => true, 'collate' => null, 'comment' => null, 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'foreign_key1' => ['type' => 'foreign', 'columns' => ['contractor_id'], 'references' => ['contractors', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
