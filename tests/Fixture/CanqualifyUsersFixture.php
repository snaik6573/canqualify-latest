...
/**
 * CanqualifyUsersFixture
 *
 */
class CanqualifyUsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'phone' => ['type' => 'string', 'length' => 25, 'default' => null, 'null' => true, 'collate' => null, 'comment' => null, 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'fk_user_id' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
