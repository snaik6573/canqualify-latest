 ...
 *
 */
class ExplanationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'explanations_fk' => ['type' => 'foreign', 'columns' => ['contractor_id'], 'references' => ['contractors', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
        ],
    ];
