...
/**
 * TrainingPercentagesFixture
 *
 */
class TrainingPercentagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'training_percentages_training_id_fkey' => ['type' => 'foreign', 'columns' => ['training_id'], 'references' => ['trainings', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
