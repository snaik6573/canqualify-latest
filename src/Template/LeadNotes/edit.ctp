...
<div class="card">
	...
	<?= $this->Form->create($leadNote) ?>
		...
		<div class="form-group row">
	        ...
	        <div>
	        <div class="col-sm-10 Follow_up Follow_upedit" style='display:none;'><?= $this->Form->control('feature_date', ['type'=>'text', 'class'=>'form-control datetimepicker','label'=>false, 'placeholder'=>'Follow up date']) ?> </div> 
	        <div class="col-sm-2 Follow_up Follow_upedit" style='display:none;'><?php echo $this->Form->control('is_completed',['type'=>'checkbox']); ?></div>       
	        <div class="status statusedit " style='display:none;'>        
	        <?= $this->Form->control('lead_status_id', ['options'=>$status,'default'=>$lead['lead_status_id'],'id'=>'statusSelection','class'=>'statusSelection statusSeledit','empty'=>false,'required'=>false, 'label'=>false]);?>
	        </div>   
	        </div> 
        </div>
        <div class="form-group row">
	        <div class="col-sm-2"></div>
	        <div class="col-sm-10 contSelect contSeledit" style='display:none;'>            
