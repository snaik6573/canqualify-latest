...
<div class="card">
    ...
    <div class="card-body card-block">  
        ...
        <?php $selectedClient = !empty($client) ? $client->id : reset($clients); ?>
            ...
            <div class="col-sm-6"><?= $this->Form->control('current_client_id', ['options'=>$clients,'default'=>$selectedClient, 'required'=>true,'empty'=>true, 'label'=>false, 'class'=>'form-control']); ?></div>
