...
if($question['client_based']) {
	...
	<div class="col-sm-4 mb-2">
		<?= $this->Form->select('employee_answers.'.$key.'.'.$k.'.answer', $question_options, ['class'=>"form-control searchSelect", 'empty'=>true, 'multiple'=>$multiselect, 'default'=>$val]) ?>
...
?>
<div class="col-sm-4 mb-2">
	<?= $this->Form->select('employee_answers.'.$key.'.answer', $question_options, ['class'=>"form-control searchSelect", 'empty'=>false, 'multiple'=>$multiselect, 'default'=>$val]) ?>
