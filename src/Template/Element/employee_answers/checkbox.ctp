...
if($question['client_based']) {
	...
	<div class="col-sm-6 mb-2">
		<?= $this->Form->select('employee_answers.'.$key.'.'.$k.'.answer', $question_options, ['multiple'=>'checkbox', 'default'=>$val]) ?>
...
?>
<div class="col-sm-9">
	<?= $this->Form->select('employee_answers.'.$key.'.answer', $question_options, ['multiple'=>'checkbox', 'default'=>$val]) ?>
