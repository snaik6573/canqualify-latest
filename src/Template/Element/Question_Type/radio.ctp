...
if($question['client_based']) {
	...
	<div class="col-sm-6 mb-2">
		<?= $this->Form->radio('contractor_answers.'.$key.'.'.$k.'.answer', $question_options, ['label'=>['class'=>'radio'], 'class'=>'', 'value'=>$val]) ?>
...
?>
<div class="col-sm-9">
	<?= $this->Form->radio('contractor_answers.'.$key.'.answer', $question_options, ['label'=>['class'=>'radio'], 'class'=>'', 'value'=>$val]) ?>
