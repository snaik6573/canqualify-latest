...
<div class="col-sm-9">
	<?= $this->Form->control('client_questions.'.$key.'.correct_answer',['type'=>'text', 'class'=>$cls.' form-control dollars '.$question->safety_type, 'label'=>false, 'value'=>$answer, 'data-role'=>$dtrole]) ?>
