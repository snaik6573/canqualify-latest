...
<!--<div class="top-bar">
	...
	<div class="row">
		...
		<li class="list-inline-item contact-email"><i class="fa fa-envelope"></i>&nbsp; <a href="mailto:info@CanQualify.com">info@CanQualify.com</a></li>
		<li class="list-inline-item contact-no"><i class="fa fa-phone"></i> &nbsp; 1-877-600-3233</li>
	    </ul>
	</div>
        <div class="col-sm-4">
	    <ul class="list-inline text-right mb-0">
		<li class="list-inline-item"><?= $this->Html->link(__('Registration'), ['controller' => 'Users', 'action' => 'register'], []) ?> </li>
		<li class="list-inline-item"><?= $this->Html->link(__('Login'), ['controller' => 'Users', 'action' => 'login'], []) ?> </li>
	    </ul>
        </div>
	</div>
    </div>
...
<div class="container">
	  ...
	  <div class="collapse navbar-collapse justify-content-end" id="navbarTogglerDemo03">
		...
		<a href="/users/register" class="fusion-background-highlight nav-link">
