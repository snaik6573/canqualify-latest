...
<div class="card">
	...
	<?= $this->Form->create($formsNDoc, array('type' => 'file')) ?>
		...
		<div class="col-lg-3">
            ...
            <div class="col-lg-3">
                <div class="form-group ">
                    <?php echo $this->Form->control('forms-n-docs.0.document_type', ['label'=>'Select Document Type', 'class'=>'form-control', 'options' => CONTRACTOR_DOC_TYPES]); ?>
                </div>
            </div>

            <div class="col-lg-3">
                <div class="form-group ">
                    <?php echo $this->Form->control('forms-n-docs.0.document_type_other', ['label'=>'If other, Please specify project name', 'class'=>'form-control']); ?>
                </div>
            </div>

		<div class="col-lg-3">
			<?php //echo $this->Form->button('<em><i class="fa fa-plus-square"></i></em> Add More', ['type' => 'button', 'class'=>'addUploadBox btn btn-success','style'=>'margin:30px 0 0 0;', 'data-fieldname'=>'forms-n-docs', 'data-showto'=>'show_to_contractor', 'data-showto-employees'=>'show_to_employees']); ?>
		</div>
		</div>
		<?php echo $this->Form->control('forms-n-docs.0.contractor_id', ['type' => 'hidden', 'value'=> $contractor_id]); ?>
...
<?php if(isset($formsNDocs) && !empty($formsNDocs)){ ?>
	...
	<tr>
		...
		<td><?php echo (isset($formsNDoc->document_type) && isset(CONTRACTOR_DOC_TYPES[$formsNDoc->document_type])) ? CONTRACTOR_DOC_TYPES[$formsNDoc->document_type] : ''; ?></td>
