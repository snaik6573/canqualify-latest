...
<div class="card">
    ...
    <?php
    $stepCount = 3;
    if($clientUser->client['registration_status'] < 4) {
        $stepCount = 4;
    }
	...
	<div class="col-md-6">
		<?=  $this->Form->create($clientUser, ['url'=> ['action'=>'addClient',1, $clientUser->id], 'class'=>'clients_add']);?>
		...
		<?php } ?>      
       <div class="form-group">
			<?php echo $this->Form->control('client.client_service_rep', ['options'=>$users,'value'=> $clientUser['client']['client_service_rep'], 'empty'=>true, 'class'=>'form-control', 'label'=>'Client Service Representative']); ?>
		</div>	     
        <div class="form-group">
			<?= $this->Form->control('user.under_configuration',[]); ?>
        </div>
		<div class="form-actions form-group">
			<?= $this->Form->control('client.registration_status', ['type'=>'hidden','value'=>'1']); ?>
	...
	<div class="row setup-content" id="step-<?= $stepNo ?>">  
	<div class="col-md-6">  
		<?= $this->Form->create($clientUser, ['url'=> ['action'=>'addClient', 2, $clientUser->id], 'class'=>'clients_add']) ?>
		<div class="form-group">
		...
		<div class="form-group">
			<?= $this->Form->control('client.company_name', ['class'=>'form-control','required'=>false]); ?>
		</div>
		...
		<div class="form-group">
			<?= $this->Form->control('client.addressline_1', ['class'=>'form-control', 'required'=>false]); ?>
		</div>
		<div class="form-group">
			<?= $this->Form->control('client.addressline_2', ['class'=>'form-control']); ?>
		</div>
		<div class="form-group">
			<?= $this->Form->control('client.city', ['class'=>'form-control', 'required'=>false]); ?>
		</div>
		<?php if($clientUser->client['registration_status'] > 1){ ?> <!-- edit code --> 
		<div class="form-group">
		<?php
		 echo $this->Form->control('client.country_id',['class'=>'form-control ajaxChange searchSelect', 'options' => $countries,'data-url'=>'/countries/getClientStates/false', 'data-responce'=>'.ajax-responce','required' => false]); ?>
		</div>
		<div class="form-group ajax-responce">
         <?php $state = [];
          if(empty($states)) {  
        	echo $this->Form->control('client.state_id', ['class'=>'form-control searchSelect', 'options' => $state, 'empty' => true,'label'=>'State','required' => false]); 
            }else{ 
            echo $this->Form->control('client.state_id', ['class'=>'form-control searchSelect', 'options' => $states,'empty' => true, 'label'=>'State','required' => false]); 
          } ?>
	  ...
	  <?php }else{ ?>  <!--- Add form code -->
		...
		<?php  $otherOption = array('0' => "Other");
		    ...
		    echo $this->Form->control('client.country_id',['class'=>'form-control ajaxChange otherCountrySelection searchSelect','id'=>'otherCountrySelection', 'options' =>$countries , 'empty' => 'Please select country', 'data-url'=>'/countries/getClientStates/true', 'data-responce'=>'.ajax-responce','label'=>false, 'required'=>false]); ?>
	    </div>
		</div>
		<div class="form-group userEnterCountry" style="display: none;">
		<?= $this->Form->control('client.country', ['type'=>'text', 'class'=>'form-control userEnterCountry','id'=>'userEnterCountry', 'placeholder'=>'Please enter your country','required'=>false]); ?> 
		</div>
		<div class="form-group userEnterCountry" style="display: none;">
		<?= $this->Form->control('client.state', ['type'=>'text', 'class'=>'form-control userEnterCountry','id'=>'userEnterCountry','placeholder'=>'Please enter your state','required'=>false]); ?>
		</div>
		<div class="form-group ajax-responce statelist">
		<?= $this->Form->label('State'); ?>
        <?php if(!empty($stateOptions)) { 
        	     echo $this->Form->control('client.state_id', ['class'=>'form-control searchSelect', 'options' => $stateOptions, 'label'=>false,'required' => false]);
             }else{ 
                 echo $this->Form->control('client.state_id', ['class'=>'form-control searchSelect', 'options' => [], 'label'=>false, 'required' => false]);
            } ?>
         <small id="countryHelp" class="form-text text-muted">States will be auto populated on country selection.</small>
		</div>
	  <?php } ?>
		<div class="form-group">
			<?= $this->Form->control('client.zip', ['class'=>'form-control', 'type'=>'text']); ?>
		</div>
		<div class="form-actions form-group">
			<?= $this->Form->control('client.registration_status', ['type'=>'hidden', 'value'=>'2']); ?>
			<?= $this->Form->button('<em><i class="fa fa-dot-circle-o"></i></em> Save & continue', ['type'=>'submit', 'class'=>'btn btn-success nextBtn']); ?>
		</div>
		<?= $this->Form->end() ?>
	</div>
	...
	<?php 
    $stepNo = 3;
    if($clientUser->client['registration_status'] < 4) {// if new Client  ?>
	<div class="row setup-content" id="step-<?= $stepNo ?>">
	<div class="col-md-12">
		<?=  $this->Form->create($clientUser, ['url'=> ['action'=>'addClient', 3, $clientUser->id,$clientUser->client_id], 'class'=>'clients_add']);?>
		...
		<?php
		$i = 0;
		if(!empty($clientUser->client->client_services)) {
		foreach ($clientUser->client->client_services as $key=>$val) { ?>
		<tr>
			<td><?= $this->Form->checkbox('client.client_services.'.$i.'.service_id', ['value'=>$val->service_id]); ?><label><?= $val->service->name; ?></label></td>
			<td><?= $this->Form->checkbox('client.client_services.'.$i.'.is_safety_sensitive', ['label'=>false]); ?></td>
			<td><?= $this->Form->checkbox('client.client_services.'.$i.'.is_safety_nonsensitive', ['label'=>false]); ?></td>
			<td><?= $this->Form->control('client_services.'.$i.'.discount', ['class'=>'form-control', 'min'=>'0', 'label'=>false]); ?></td>
			<td><?= $this->Form->checkbox('client.client_services.'.$i.'.is_percentage', ['label'=>false]); ?>
			<?= $this->Form->control('client.client_services.'.$i.'.created_by', ['type'=>'hidden', 'value'=>$user_id]); ?>
			<?= $this->Form->control('client.client_services.'.$i.'.id'); ?>
			</td>
		</tr>
		<?php 
		$i++; 
		...
		?>
		<tr>		
			<td><?= $this->Form->checkbox('client.client_services.'.$i.'.service_id', ['value'=>$key]); ?><label><?= $val; ?></label></td>
			<td><?= $this->Form->checkbox('client.client_services.'.$i.'.is_safety_sensitive', ['label'=>false]); ?></td>
			<td><?= $this->Form->checkbox('client.client_services.'.$i.'.is_safety_nonsensitive', ['label'=>false]); ?></td>
			<td><?= $this->Form->control('client.client_services.'.$i.'.discount', ['class'=>'form-control', 'min'=>'0', 'label'=>false]); ?></td>
			<td><?= $this->Form->checkbox('client.client_services.'.$i.'.is_percentage', ['label'=>false]); ?>
			<?= $this->Form->control('client.client_services.'.$i.'.created_by', ['type'=>'hidden', 'value'=>$user_id]); ?>
			<?= $this->Form->control('client.client_services.'.$i.'.client_id', ['type'=>'hidden', 'value'=>$clientUser->client['id']]) ?>
			</td>
		</tr>
		<?php
		}
		...
		<?php
		$i = 0;
		if(!empty($clientUser->client->client_modules)) {		
		foreach ($clientUser->client->client_modules as $key=>$val){ ?>
		<tr><td>
		<?= $this->Form->checkbox('client.client_modules.'.$i.'.module_id', ['value'=>$val->module_id]); ?><label><?= $val->module->name; ?></label>
		<?= $this->Form->control('client.client_modules.'.$i.'.created_by', ['type'=>'hidden', 'value'=>$user_id]); ?></td>
		<?= $this->Form->control('client.client_modules.'.$i.'.id', ['type'=>'hidden']); ?>
		</td></tr>
		<?php
		$i++;
		}
		...
		?>
		<tr>
		<td><?= $this->Form->checkbox('client.client_modules.'.$i.'.module_id', ['value'=>$key, 'label'=>false, 'required'=>false]);?><?= $val;?>
		<?= $this->Form->control('client.client_modules.'.$i.'.client_id', ['type'=>'hidden', 'value'=>$clientUser->client['id']]) ?>
		<?= $this->Form->control('client.client_modules.'.$i.'.created_by', ['type'=>'hidden', 'value'=>$user_id]); ?></td>
		</tr>
		<?php 
		}
		...
		<div class="form-actions form-group">
			<?= $this->Form->control('client.registration_status', ['type'=>'hidden', 'value'=>'3']); ?>
			<?= $this->Form->button('<em><i class="fa fa-dot-circle-o"></i></em> Save & continue', ['type'=>'submit', 'class'=>'btn btn-success nextBtn']); ?>
		</div>		
		<?= $this->Form->end() ?>
	</div>
	...
	<div class="col-md-12">		
		...
		if($cl->service->id == 4){ // skip employeeQual and safetyQual
			continue;
		}
		?>		
		...
		<?= $this->Form->create($question, ['url'=>['action'=>'addquestions', $clientUser->client->id,$clientUser->id]]);?>
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<?= $this->Form->control('client_id', ['type'=>'hidden', 'value'=>$clientUser->client->id]); ?>
				<?= $this->Form->control('client_user_id', ['type'=>'hidden', 'value'=>$clientUser->id]); ?>
		...
		<?= $this->Form->create($clientUser, ['url'=> ['action'=>'addClientQuestions', 4, $clientUser->client->id], 'class'=>'clientQuestion saveAjax', 'data-responce'=>".alert-wrap-$c"]);?>
...
<button type="button" class="btn btn-secondary btn-sm mb-1 pull-right" data-toggle="modal" data-target="#addQuestion_<?= $cat->id;?>">Add Question</button></th>
		...
		<tr>
           ...
           <div class="<?= $v->is_parent ? 'root-question' : '' ?><?= in_array($v->question_id, $parent_questions) && $v->question_id != '' ? ' child-question' : '' ?>"  data-questionId="<?= $v->id?>" <?= $v->parent_option!= '' ? 'data-parentqId="'.$v->question_id.'" data-parent="'.$v->question_id.'-'.$v->parent_option.'"' : ''?> >
			...
			<?= $this->Form->control('client_questions.'.$j.'.client_id', ['type'=>'hidden', 'value'=>$clientUser->client->id]) ?>
		...
		<div class="modal fade" id="addQuestion_<?= $cat->id ?>" tabindex="-1" role="dialog" aria-labelledby="addQuestionLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg" role="document">
		<?= $this->Form->create($question, ['url'=>['action'=>'addquestions', $clientUser->client->id]]);?>
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="mediumModalLabel">Add Question</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		...
		<div class="col-sm-12 alert-wrap-<?= $c ?>"></div>	
		<?= $this->Form->create($clientUser, ['url'=> ['action'=>'addClientQuestions', 4, $clientUser->client_id], 'class'=>'clientQuestion saveAjax', 'data-responce'=>".alert-wrap-$c"]);?>
		<table class="table table-responsive">
		<thead class="thead-dark">		
			<tr>
			<th><label><?= $cat->name; ?></label></th>					
		...
		?>
         ...
         <?php }?>
		<div class="form-actions form-group">
			<?= $this->Form->create($clientUser, ['url'=> ['action'=>'addClient', 4, $clientUser->id,$clientUser->client_id], 'class'=>'clients_add']);?>
			<?= $this->Form->control('client.registration_status', ['class'=>'form-control','type'=>'hidden','value'=>'4']); ?>
