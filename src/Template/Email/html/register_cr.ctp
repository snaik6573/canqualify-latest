    ...
    <table width="100%" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <div style ="padding:0px 20px 20px;">	
                <p>Dear &nbsp;<?=$full_name?></p>
	            <p>Welcome to CanQualify.com.</p><br><br>
	            <p>You were registered successfully.</p>
	            <p>Please click the button below to set your password:</p>
                    <table cellspacing="0" cellpadding="0">             
                        <td  style ="border-radius: 2px; padding:5px;" bgcolor="#1874CD">
                                      <a  style ="font-size: 14px;color: #ffffff; font-weight: bold;display: inline-block;text-decoration: none;" href="<?= $reseturl ?>" > Click Here </a>
                        </td>
                    </table>
                <p style="margin-bottom:0px;margin-top:10px;">In case you cannot see or click on the button above, copy the link below and paste it in your browser address bar and press Enter</p> 
                <p style="margin:0px;"><?= $reseturl ?></p>
                <p>
