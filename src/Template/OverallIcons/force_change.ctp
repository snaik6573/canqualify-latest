...
<div class="card">
	...
	if($suggestedOverallIcon != null) {
		...
		<div class="row form-group">
		<label class="col-sm-5">Update Overall Status</label>			<div class="col-sm-4">			
	...
	<?php
		...
		$i++;
            ...
            /*hardcoded for insurance iwatani*/
                        ...
                        echo $this->Form->control('icons.' . $i . '.contractor_id', ['type' => 'hidden', 'value' => $contractor_id]);
		...
		<div class="row form-group">
			...
			<div class="col-sm-3"><?php echo $this->Form->control('icon', ['options'=>$icons, 'type'=>'radio', 'required'=>true, 'label'=>false]); ?></div>
    ...
    <div class="row form-group">
        ...
        <?php if($activeUser['role_id']==CLIENT) { 
             echo $this->Form->control('show_to_clients',['type'=>'hidden','value'=>true]);
        } else { ?>
		<div class="col-sm-3">
