 ...
 * @var \App\Model\Entity\EmailWizards[]|\Cake\Collection\CollectionInterface $EmailCampaign
 */ 
?>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select multiple="multiple" class="form-control siteAddchk" name="cc_mail[]">
                                <?php 
                        foreach($canq_cr as $key=>$val) {
                            $selected = '';
                            if($this->User->isClient()){ $selected = 'selected="selected"'; }
                            echo '<option value="'.$key.'" '.$selected.'>'.$val.'</option>';
                        }
                    ?>
                            </select>
                ...
                <div class="row">
                    <div class="col-sm-3 appendDiv">
                        <div class="form-group uploadWraper">
                            ...
                            <?php echo $this->Form->control('mail-attachment.0.document', ['label'=>false, 'type'=>'hidden', 'class'=>'documentName']); ?>
                            <?php echo $this->Form->file('mail-attachment.0.uploadFile', ['label'=>false, 'accept'=>'.images/*, .pdf,.xls, .xlsx, .doc', 'required'=>'false']); ?>
