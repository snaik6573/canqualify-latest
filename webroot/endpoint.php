...
$clientPrivateKey = $_SERVER['S3_ACCESS_SECRET'];
// These two keys are only needed if the delete file feature is enabled
// or if you are, for example, confirming the file size in a successEndpoint
// handler via S3's SDK, as we are doing in this example.
$serverPublicKey = $_SERVER['S3_ACCESS_KEY'];
$serverPrivateKey = $_SERVER['S3_ACCESS_SECRET'];
// The following variables are used when validating the policy document
// sent by the uploader. 
$expectedBucketName = 'demo-data-canqualifyer';
$expectedHostName = 'https://demo-data-canqualifyer.s3.amazonaws.com/'; // v4-only
...
function handleCorsRequest() {
    ...
    header('Access-Control-Allow-Origin: https://demo.canqualifier.com/');
}
// Only needed in cross-origin setups
